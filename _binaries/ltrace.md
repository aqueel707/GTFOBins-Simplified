...
- id: file-read
  ...
  capabilities:
  - read
  command: ltrace -F /path/to/input-file /dev/null
  notes: The file is parsed as a configuration file and its content is shown as error messages.
- id: file-write
  description: Write content to an arbitrary file.
  capabilities:
  - write
  command: ltrace -s 999 -o /path/to/input-file ltrace -F DATA
